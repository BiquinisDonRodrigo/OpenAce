...
Si usas `docker-compose.vps.simple.yaml` o `docker-compose.vps.yaml`, este patron ya viene aplicado. Si partes de otro compose, editalo para que los puertos internos solo escuchen en `127.0.0.1`:
